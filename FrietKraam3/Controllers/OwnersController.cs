...
namespace FrietKraam3.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(FrietKraamContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Owners != null ? 
                          ...
                          Problem("Entity set 'FrietKraamContext.Owners'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FrietKraamContext.Owners'  is null.");
            }
            var owner = await _context.Owners.FindAsync(id);
            if (owner != null)
            {
